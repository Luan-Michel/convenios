...
@section('content')
        ...
        <div>
          <div style="padding: 20px" id="financiador">
            ...
            Para a inserção, edição ou exclusão de um financiado no sistema, consulte as seções abaixo. Para vinculação de um financiador a um convênio, consulte a página de ‘Convênios’ nesse manual.
            ...
            Caso tenha preenchido um campo de forma incorreta e o financiador tenha sido cadastrado, edite-o
            ...
            botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição do financiador, as alterações
          ...
          <div style="padding: 20px" id="categoria">
            ...
            Para a inserção, edição ou exclusão de uma categoria no sistema, consulte as seções abaixo. Para vinculação de uma categoria a um convênio, consulte a página de ‘Convênios’ nesse manual.
            ...
            Caso tenha preenchido o campo de forma incorreta e a categoria tenha sido cadastrada, edite-a (consulte a próxima seção para detalhes quanto a modificação de categorias já cadastradas). Caso algum erro tenha sido gerado na tentativa de inserção da categoria no sistema, o cadastro não será efetivado e recomenda-se a leitura do erro apresentado para a validação desse.
            ...
            Clique no botão [botão] para salvar a alteração realizada. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição da categoria, a alteração não será efetivada e recomenda-se a leitura do erro apresentado para a validação dessa.
          ...
          <div style="padding: 20px" id="convenio">
            ...
            Para a inserção, edição ou exclusão de um convênio no sistema, consulte as seções abaixo.
            ...
            Insira o investimento total atribuído ao convênio no campo ‘Valor’. A moeda utilizada nesse campo é o real. Esse campo não é editável.
            As datas de início, limite de execução, prestação de contas e limite de vigência são requeridas nos campos de respectivas identificações. Assegure-se de que as datas não se sobreponham. Esses campos não são editáveis. Adicione um termo aditivo a um convênio caso seu limite de execução, vigência ou prestação de contas tenham sido alterados (consulte a página de ‘Termo Aditivo’ para detalhes).
            ...
            Clique no botão [Salvar] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição do convênio, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="previoempenho">
            ...
            Para a inserção, edição ou exclusão de um prévio empenho no sistema, consulte as seções abaixo.
            ...
            Recomenda-se redobrada atenção no preenchimento dos campos de inserção de um prévio empenho. Muitos deles não são editáveis, o que significa que não poderão ser alterados após seu cadastro.
            ...
            Insira o ano e o número do prévio empenho nos respectivos campos numéricos. No campo ‘Ano do prévio’ utilize o ano em que o prévio empenho foi gerado. No campo ‘Número do prévio’ utilize […]. Esses campos não são editáveis.
            Utilize o formato dd/mm/aaaa na inserção da data do prévio empenho no campo ‘Data do prévio’. Utilize a data de quando esse foi gerado e respeite o limite imposto pelo convênio ao qual está vinculado. Esse campo não é editável.
            Insira no campo numérico ‘Valor do prévio’ o valor estimado no prévio empenho. Esse valor deve estar dentro do limite imposto pelo convênio ao qual o prévio empenho está vinculado. Sua edição não é permitida após cadastro. Escolha o tipo da moeda utilizada no campo editável ‘Moeda’. Esse não pode ser manipulado de forma manual e a inserção de novo tipo de moeda não é suportada. Caso seja necessária a inserção de novos registros a esses campos, contate o NTI.
            O campo ‘Financiador’ se refere ao financiador do prévio empenho de um convênio. Não é obrigatório que esse campo seja preenchido com o financiador vinculado ao convênio objeto. Atente ao escolher dentre os financiadores apresentados no campo – o campo não pode ser manipulado de forma manual e não é editável. É possível adicionar novos financiadores para vinculação a um prévio empenho no cadastro de ‘Financiador’ (consulte o manual das páginas para detalhes).
            Os campos ‘Tipo compra’ e ‘Fonte’ se referem aos gastos planejados com o prévio empenho e apresentam opções para preenchimento. Caso seja necessária a inserção de novos registros a esses campos, contate o NTI. Ambos são não editáveis.
            ...
            Deixe campos não obrigatórios em branco caso queira excluir seus conteúdos.
            Clique no botão [botão] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição do prévio empenho, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="pessoa">
            ...
            Para a inserção, edição ou exclusão de uma pessoa no sistema, consulte as seções abaixo. Para vinculação de uma pessoa a um convênio, consulte a página de ‘Participantes’ nesse manual.
            ...
            O campo ‘CPF’ exige o número regularizado da pessoa junto a receita federal. Esse campo não é editável. Utilize a formatação sendo recomendada no campo.
            ...
            A edição de um endereço de correio eletrônico não é permitida. Remova um endereço incorreto através do botão [botão] junto ao endereço e adicione-o corretamente.
            Clique no botão [botão] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição da pessoa, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="participante">
            ...
            Para a inserção, edição ou exclusão de participantes no sistema, consulte as seções abaixo.
            ...
            Clique no botão [botão] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição de participante, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="plano_de_trabalho">
            ...
            Para a inserção, edição ou exclusão de plano de trabalho de um convênio, consulte as seções abaixo.
            ...
            O campo ‘Sequência meta aplicação’ se refere a ordem da meta dentro do plano de trabalho do convênio. Não é obrigatório que uma sequência seja mantida nessa inserção, mas ela é recomendada para uma melhor organização dentro do plano de trabalho. O campo é numérico e editável.
            Insira a titulação da meta no campo ‘Título meta aplicação’. Junto ao número de sequência, esse campo define a identificação da meta dentro do plano de trabalho do convênio. Você poderá editá-lo posteriormente.
            Os campos ‘Início da meta’ e ‘Término da meta’ se referem ao período estipulado para a aplicação de uma meta. Insira a data quando ela será iniciada e terminada, respectivamente, respeitando o limite imposto pelo convênio ao qual está vinculada. Utilize a formatação recomendada nos campos (dd/mm/aaaa). Esses campos não são editáveis.
            ...
            Clique no botão [botão] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição de meta, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="etapa_plano_de_trabalho">
            ...
            Para a inserção, edição ou exclusão de uma etapa a uma meta de convênio, consulte as seções abaixo.
            ...
            Insira a data estipulada para o início da etapa no campo ‘Data de Início’ e a data estipulada para o fim da etapa no campo ‘Data de Término’. Utilize a formatação recomendada nos campos (dd/mm/aaaa) e respeite o limite imposto pela meta ao qual está vinculada. Esses campos não são editáveis e, portanto, não poderão ser alterados após cadastro de meta.
            Utilize o campo numérico ‘Quantidade Unidade’ para inserir a quantidade de material adquirido na etapa. Se mais aplicável, utilize o campo ‘Unidade Medida’ para expressar essa informação. Esses campos não são editáveis. No campo ‘Unidade Medida’, preencha com […].
            Existem quatro campos referentes ao valor investido na etapa. Insira o valor utilizado na etapa no campo ‘Valor total’. Insira o valor […] no campo ‘Valor Reservado’. Insira o valor empenhado para a etapa no campo ‘Valor empenhado’ e insira o valor […] no campo ‘Valor Saldo’. Utilize a moeda real em todos os campos e respeite os limites impostos pelo convênio ao qual a etapa está vinculada através do plano de trabalho. Esses campos não são editáveis.
            Após preencher os campos obrigatórios, clique no botão [botão] para vincular uma etapa ao plano de trabalho de um convênio.
            Caso tenha preenchido algum campo de forma incorreta e a etapa tenha sido cadastrada, edite-a (consulte a próxima seção para detalhes quanto a modificação de etapas). Caso algum campo protegido tenha sido preenchido de forma incorreta, exclua a etapa imediatamente (consulte a próxima seção para detalhes quanto a exclusão de etapas) e recrie-ao corretamente. Caso isso não seja possível (isso é, a etapa já está sendo utilizada dentro do sistema) contate o NTI. Caso algum erro tenha sido gerado na tentativa de vinculação da etapa a meta de um convênio, o cadastro não será efetivado e recomenda-se a leitura do erro apresentado para a validação desse.
            ...
            Deixe campos não obrigatórios em branco caso queira excluir seus conteúdos.
            Clique no botão [botão] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição da etapa, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="participante_etapa">
            ...
            Para a inserção, edição ou exclusão de um participante a uma etapa, consulte as seções abaixo.
            ...
            Caso tenha preenchido algum campo de forma incorreta e o participante de etapa tenha sido cadastrado, edite-o (consulte a próxima seção para detalhes quanto a modificação desse vínculo). Caso algum erro tenha sido gerado na tentativa de vinculação de participante a etapa de um convênio, o cadastro não será efetivado e recomenda-se a leitura do erro apresentado para a validação desse.
            ...
            Clique no botão [botão] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição de participante de etapa, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="item_etapa">
            ...
            Para a inserção, edição ou exclusão de itens no sistema, consulte as seções abaixo.
            ...
            Caso tenha preenchido algum campo de forma incorreta e o item tenha sido cadastrado, edite-o (consulte a próxima seção para detalhes quanto a modificação de itens). Caso algum erro tenha sido gerado na vinculação de um item a uma etapa, o cadastro não será efetivado e recomenda-se a leitura do erro apresentado para a validação desse.
            ...
            Clique no botão [botão] para salvar alterações realizadas. Toda alteração que não for salva através desse botão será perdida. Caso algum erro tenha sido gerado na tentativa de edição de um item, as alterações não serão efetivadas e recomenda-se a leitura do erro apresentado para a validação dessas.
          ...
          <div style="padding: 20px" id="diaria">
            ...
            Para a inserção, edição ou exclusão de diárias a um prévio empenho, consulte as seções abaixo.
            ...
            <h4>Edição</h4>
            A edição de uma diária não é permitida após a vinculação com um prévio empenho. Todos os campos são protegidos. Caso necessário, contate o NTI para modificação do registro.
